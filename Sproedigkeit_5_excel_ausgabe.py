...
probe_sheets = [sheet for sheet in xls.sheet_names if sheet.startswith("Probe")]  # Nur Blätter, die mit "Probe" beginnen
...
with pd.ExcelWriter("Analyse_Ergebnisse.xlsx") as writer:
    ...
    for sheet_name in probe_sheets:
        ...
        # Speichern der Rohdaten und der geglätteten Werte auf einem Blatt für jede Probe
